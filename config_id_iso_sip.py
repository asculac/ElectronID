...
variables_ee = ["ele_psEoverEraw"]
variables_iso = ["ele_pfPhotonIso", "ele_pfChargedHadIso", "ele_pfNeutralHadIso"]
variables_sip  = ["mu_sip", "mu_dxy", "mu_dz"]


variables_base_eb         = variables_base
variables_base_ee         = variables_base + variables_ee
variables_base_iso_eb     = variables_base_eb + variables_iso
variables_base_iso_ee     = variables_base_ee + variables_iso
variables_base_iso_sip_eb = variables_base_iso_eb + variables_sip
variables_base_iso_sip_ee = variables_base_iso_ee + variables_sip
...
# Iso ID
cfg["trainings"]["Summer_16_ID_ISO_SIP"]["EB1_5"] = {
        "cut": "ele_pt < 10. & abs(scl_eta) < 0.800",
        "variables": variables_iso_sip_eb,
        "label": r'EB1 5 - 5 < $p_T$ < 10 GeV, ($|\eta| < 0.8$)',
        }

cfg["trainings"]["Summer_16_ID_ISO_SIP"]["EB2_5"] = {
        "cut": "ele_pt < 10. & abs(scl_eta) >= 0.800 & abs(scl_eta) < 1.479",
        "variables": variables_iso_sip_eb,
        "label": r'EB2 5 - 5 < $p_T$ < 10 GeV, ($|\eta| > 0.8$)',
        }

cfg["trainings"]["Summer_16_ID_ISO_SIP"]["EB1_10"] = {
        "cut": "ele_pt >= 10. & abs(scl_eta) < 0.800",
        "variables": variables_iso_sip_eb,
        "label": r'EB1 10 - $p_T$ > 10 GeV, ($|\eta| < 0.8$)',
        }

cfg["trainings"]["Summer_16_ID_ISO_SIP"]["EB2_10"] = {
        "cut": "ele_pt >= 10. & abs(scl_eta) >= 0.800 & abs(scl_eta) < 1.479",
        "variables": variables_iso_sip_eb,
        "label": r'EB2 10 - $p_T$ > 10 GeV, ($|\eta| > 0.8$)',
        }

cfg["trainings"]["Summer_16_ID_ISO_SIP"]["EE_5"] = {
        "cut": "ele_pt < 10. & abs(scl_eta) >= 1.479",
        "variables": variables_iso_sip_ee,
        "label": r'EE 5 - 5 < $p_T$ < 10 GeV',
        }

cfg["trainings"]["Summer_16_ID_ISO_SIP"]["EE_10"] = {
        "cut": "ele_pt >= 10. & abs(scl_eta) >= 1.479",
        "variables": variables_iso_sip_ee,
...
cfg["working_points"]["Summer_16_ID_ISO_SIP"]["mvaEleID-Summer16-ID-ISO-HZZ"] = {
    "type":           "constant_cut_sig_eff_targets",
    "categories":     ["EB1_5", "EB2_5", "EE_5", "EB1_10", "EB2_10", "EE_10"],
