...
plot_dir   = join("plots", "compare_2018")
...
print("Signal Ana: ", sig.size)
print("Background Ana: ", bkg.size)
print("Signal Marko: ", sig_marko.size)
print("Background Marko: ", bkg_marko.size)

fig = plt.figure(figsize=(10.4, 8.8))
#ax.ylim(200)
#ax = df["ele_pt"].plot()
#df_marko["ele_pt"].plot(ax=ax)
plt.xlim([0, 300])
#plt.ylim([0, 1000])
plt.hist([sig["ele_pt"], bkg["ele_pt"],sig_marko["ele_pt"], bkg_marko["ele_pt"]],bins=50, histtype=u'step', label=['Ana sig','Ana bkg', 'Marko sig', 'Marko bkg'], alpha=1)  #bins=np.linspace(0,1000,50)
...
fig = plt.figure(figsize=(10.4, 8.8))
plt.xlim([-3, 3])
plt.hist(sig["scl_eta"], bins=50, histtype='step', label=['Ana sig'], alpha=1) #bins=np.linspace(0,1000,50)
plt.hist(bkg["scl_eta"], bins=50, histtype='step', label=['Ana bkg'], alpha=1)
plt.hist(sig_marko["scl_eta"], bins=50, histtype='step', label=['Marko sig'], alpha=1)
...
fig = plt.figure(figsize=(10.4, 8.8))
plt.xlim([-3,3])
plt.hist([sig_marko["scl_eta"],bkg_marko["scl_eta"]], bins=50, histtype='step', alpha=1)
plt.savefig(join(plot_dir, "compare_eta_marko.png"), bbox_inches='tight')
plt.close()

fig = plt.figure(figsize=(10.4, 8.8))
plt.xlim([-3,3])
plt.hist([sig["scl_eta"],bkg["scl_eta"]], bins=50, histtype='step', alpha=1)
plt.savefig(join(plot_dir, "compare_eta_ana.png"), bbox_inches='tight')
plt.close()
...
#plt.hist([df["ele_oldsigmaietaieta"], df_marko["ele_oldsigmaietaieta"]], bins=50, histtype=u'step', label=['Ana', 'Marko'], alpha=1)
plt.legend(loc="upper left", ncol=1)
...
#plt.hist([df["ele_oldsigmaiphiiphi"], df_marko["ele_oldsigmaiphiiphi"]], bins=50, histtype=u'step', label=['Ana', 'Marko'], alpha=1)
plt.legend(loc="upper left", ncol=1)
...
#plt.hist([df["ele_oldcircularity"], df_marko["ele_oldcircularity"]], bins=50, histtype=u'step', label=['Ana', 'Marko'], alpha=1)
plt.legend(loc="upper left", ncol=1)
...
#plt.hist([df["ele_oldr9"], df_marko["ele_oldr9"]], bins=50, histtype=u'step', label=['Ana', 'Marko'], alpha=1)
plt.legend(loc="upper left", ncol=1)
...
#plt.hist([df["ele_scletawidth"], df_marko["ele_scletawidth"]], bins=50, histtype=u'step', label=['Ana', 'Marko'], alpha=1)
plt.legend(loc="upper left", ncol=1)
...
#plt.hist([df["ele_sclphiwidth"], df_marko["ele_sclphiwidth"]], bins=50, histtype=u'step', label=['Ana', 'Marko'], alpha=1)
plt.legend(loc="upper left", ncol=1)
...
#plt.hist([df["ele_oldhe"], df_marko["ele_oldhe"]], bins=50, histtype=u'step', label=['Ana', 'Marko'], alpha=1)
plt.legend(loc="upper left", ncol=1)
...
#plt.hist([df["ele_kfhits"], df_marko["ele_kfhits"]], bins=50, histtype=u'step', label=['Ana', 'Marko'], alpha=1)
plt.legend(loc="upper left", ncol=1)
...
#plt.hist([df["ele_expected_inner_hits"], df_marko["ele_expected_inner_hits"]], bins=50, histtype=u'step', label=['Ana', 'Marko'], alpha=1)
plt.legend(loc="upper left", ncol=1)
...
#plt.hist([df["ele_kfchi2"], df_marko["ele_kfchi2"]], bins=50, histtype=u'step', label=['Ana', 'Marko'], alpha=1)
plt.legend(loc="upper left", ncol=1)
...
#plt.hist([df["ele_gsfchi2"], df_marko["ele_gsfchi2"]], bins=50, histtype=u'step', label=['Ana', 'Marko'], alpha=1)
plt.legend(loc="upper left", ncol=1)
...
#plt.hist([df["ele_fbrem"], df_marko["ele_fbrem"]], bins=50, histtype=u'step', label=['Ana', 'Marko'], alpha=1)
plt.legend(loc="upper left", ncol=1)
...
#plt.hist([df["ele_gsfhits"], df_marko["ele_gsfhits"]], bins=50, histtype=u'step', label=['Ana', 'Marko'], alpha=1)
plt.legend(loc="upper left", ncol=1)
...
#plt.hist([df["ele_conversionVertexFitProbability"], df_marko["ele_conversionVertexFitProbability"]], bins=50, histtype=u'step', label=['Ana', 'Marko'], alpha=1)
plt.legend(loc="upper left", ncol=1)
...
#plt.hist([df["ele_ep"], df_marko["ele_ep"]], bins=50, histtype=u'step', label=['Ana', 'Marko'], alpha=1)
plt.legend(loc="upper left", ncol=1)
...
#plt.hist([df["ele_eelepout"], df_marko["ele_eelepout"]], bins=50, histtype=u'step', label=['Ana', 'Marko'], alpha=1)
plt.legend(loc="upper left", ncol=1)
...
#plt.hist([df["ele_IoEmIop"], df_marko["ele_IoEmIop"]], bins=50, histtype=u'step', label=['Ana', 'Marko'], alpha=1)
plt.legend(loc="upper left", ncol=1)
...
#plt.hist([df["ele_deltaetain"], df_marko["ele_deltaetain"]], bins=50, histtype=u'step', label=['Ana', 'Marko'], alpha=1)
plt.legend(loc="upper left", ncol=1)
...
#plt.hist([df["ele_deltaphiin"], df_marko["ele_deltaphiin"]], bins=50, histtype=u'step', label=['Ana', 'Marko'], alpha=1)
plt.legend(loc="upper left", ncol=1)
...
#plt.hist([df["ele_deltaetaseed"], df_marko["ele_deltaetaseed"]], bins=50, histtype=u'step', label=['Ana', 'Marko'], alpha=1)
plt.legend(loc="upper left", ncol=1)
...
#plt.hist([df["rho"], df_marko["rho"]], bins=50, histtype=u'step', label=['Ana', 'Marko'], alpha=1)
plt.legend(loc="upper left", ncol=1)
...
#plt.hist([df["ele_psEoverEraw"], df_marko["ele_psEoverEraw"]], bins=50, histtype=u'step', label=['Ana', 'Marko'], alpha=1)
plt.legend(loc="upper left", ncol=1)
...
#plt.hist([df["ele_pfPhotonIso"], df_marko["ele_pfPhotonIso"]], bins=50, histtype=u'step', label=['Ana', 'Marko'], alpha=1)
plt.legend(loc="upper left", ncol=1)
...
#plt.hist([df["ele_pfChargedHadIso"], df_marko["ele_pfChargedHadIso"]], bins=50, histtype=u'step', label=['Ana', 'Marko'], alpha=1)
plt.legend(loc="upper left", ncol=1)
...
#plt.hist([df["ele_pfNeutralHadIso"], df_marko["ele_pfNeutralHadIso"]], bins=50, histtype=u'step', label=['Ana', 'Marko'], alpha=1)
plt.legend(loc="upper left", ncol=1)
